...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            ...
            StatusSurfacePreviewItem::FiveHourLimitReset => "5h resets 18:30",
            StatusSurfacePreviewItem::WeeklyLimit => "weekly 0%",
            StatusSurfacePreviewItem::WeeklyLimitReset => "weekly resets 18:30 on 3 May",
    ...
    pub(crate) fn iter() -> impl Iterator<Item = Self> {
        [
            ...
            Self::ContextUsed,
            Self::FiveHourLimit,
            Self::FiveHourLimitReset,
            Self::WeeklyLimit,
            Self::WeeklyLimitReset,
            Self::CodexVersion,
